...
\textcolor{black!30}{\lipsum[1-1]}
\end{abstract} 
\input{./sections/1_intro.tex}
\input{./sections/2_priorlit.tex}
\input{./sections/3_model_data.tex}
\input{./sections/4_methods.tex}
\input{./sections/5_results.tex}
\input{./sections/6_analysis.tex}
\input{./sections/7_conclusion.tex}
\input{./sections/8_limitations.tex}
\input{./sections/9_ethics.tex}
