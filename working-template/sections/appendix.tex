...
\cmidrule(lr){2-7}
 ...
 & \textbf{$\Phi$} & \textbf{N} \\
\midrule
\textbf{UPR x Emotional Validation}        & \textbf{0.243} & 1000 & \textbf{0.369} & 750 & 0.304 & 1687 \\
...
\cmidrule(lr){2-7}
 ...
 & \textbf{$\Phi$} & \textbf{N} \\
\midrule
\textbf{UPR x Emotional Validation}        & 0.509 & 1000  & \textbf{0.544} & 700  & 0.528 & 1613 \\
UPR x Indirect Language           & 0.236 & 1000  & \textbf{0.311} & 700  & 0.258 & 1613 \\
...
CoT with dialog insertion was evaluated as a control mechanism, with results varying across models. For Claude, accuracy declined from 0.45 to 0.37 and macro-average F1 from 0.41 to 0.30 with CoT insertion (Table~\ref{tab:claude_cot_comparison}). At the class level, recall for \texttt{NO\_VERDICT} rose from 0.12 to 0.76, while recall for \texttt{YTA} fell from 0.48 to 0.08. These results show that CoT dialog insertion redistributed performance across classes rather than producing uniform changes. Full model performances are provided in the appendix.
...
\cmidrule(lr){2-5} \cmidrule(lr){6-9}
 ...
 & Precision & Recall & F1-score & Support \\
\midrule
NO\_VERDICT & 0.30 & 0.76 & 0.43 & 50 & 0.60 & 0.12 & 0.21 & 50 \\
